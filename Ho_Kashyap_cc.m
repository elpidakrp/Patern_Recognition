function [a, b,err_KH] = Ho_Kashyap_cc(train_features, train_targets,type, Max_iter, b_min, eta)
...
%     XL=[ XA(1) XA(2) -(a(3)+a(2)*XA(3))/a(1) -(a(3)+a(2)*XA(4))/a(1)];
%     YL=[-(a(3)+a(1)*XA(1))/a(2) -(a(3)+a(1)*XA(2))/a(2) XA(3) XA(4)];
%     plot(XL,YL, 'g');ylim([0 3]);
    k = k+1;
    e = (Y' * a)' - b;
    e_plus = 0.5*(e + abs(e));
    b = b + 2*eta*e_plus;
    ...
    KH_out=2*(a'*train_features>0)-1;
    err_KH(k)=sum(KH_out.*train_targets<0)/150;
    
%     XL=[ XA(1) XA(2) -(a(3)+a(2)*XA(3))/a(1) -(a(3)+a(2)*XA(4))/a(1)];
%     YL=[-(a(3)+a(1)*XA(1))/a(2) -(a(3)+a(1)*XA(2))/a(2) XA(3) XA(4)];
%     plot(XL,YL, 'r');ylim([0 3]);
end
if (k == Max_iter)
